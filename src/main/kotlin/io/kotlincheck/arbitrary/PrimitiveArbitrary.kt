...
fun <T> oneOf(values: List<T>): OneOfArbitrary<T> = OneOfArbitrary(values)

fun <T> oneOf(vararg values: T): OneOfArbitrary<T> = OneOfArbitrary(values.asList())

fun <T> oneOf(values: Set<T>): OneOfArbitrary<T> = OneOfArbitrary(values.toList())

fun <T> oneOf(gens: List<Gen<T>>): OneOfGenArbitrary<T> = OneOfGenArbitrary(gens)

fun <T> oneOf(vararg gens: Gen<T>): OneOfGenArbitrary<T> = OneOfGenArbitrary(gens.asList())

fun <T> oneOf(gens: Set<Gen<T>>): OneOfGenArbitrary<T> = OneOfGenArbitrary(gens.toList())
